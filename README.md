...
과학기술정보통신부 주관 **데이터 크리에이터 캠프**에서 수행한 팀 프로젝트입니다. 위성 영상을 이용해 대기오염 배출원(굴뚝·산업단지)을 탐지·분석하는 3단계 AI 파이프라인을 구축했습니다.
...
팀장으로서 프로젝트 방향 설정, 일정 관리, 팀원 코드 리뷰를 담당했고, Mission 1(Detection)과 Mission 2(Regression)를 직접 설계·구현했습니다.
